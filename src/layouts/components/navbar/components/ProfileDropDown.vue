    ...
    <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
      ...
      <vs-dropdown-menu class="vx-navbar-dropdown">
        <ul style="min-width: 9rem">
          ...
          >
            <feather-icon icon="UnlockIcon" svgClasses="w-4 h-4" />
...
export default {
  ...
  computed: {
    ...
    getProfile() {
      ...
      getRolAdmin() {
            return this.$store.getters["dsoaLogin/buscaRol"]('TAVO_ADMIN');
        }, 
  },
  methods: {
    ...mapActions({
