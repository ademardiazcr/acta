...
export function aesDencrypt(txt) {
    ...
    let iv = 'sinasinasisinaaa'; // change to your iv
...
/*export function traerLocalStorage() {
    ...
    if (localStorage.getItem('profile')) {
        ...
        profileText = localStorage.getItem('profile');
        
        //console.log("en libreria1 ", profileText);
        ...
        //console.log("en libreria ", JSON.stringify(profile));
        return profile;
...
export function traerLocalStorage() {
    ...
    if (localStorage.getItem('profile')) {
        ...
        //recuperando profile 
        console.log("traerLocalStorage", profileText);
        //profileText = atob(profileText);
...
export const FechaHoraformat = {
    enableTime: true,
    dateFormat: "d-m-Y H:i"
};

export const Horaformat = {
    enableTime: true,
    enableSeconds: true,
    noCalendar: true
};
...
export function GetSdtLoginString(sdtLogin) {
    ...
    xmlLog += "<Avatar>" + sdtLogin.Avatar + "</Avatar>";
