    ...
    routes: [{
            ...
            children: [
...

                {
                    ...
                    name: "pedidos",
                    component: () =>
                        import ("./divisoft/BaseComentario.vue"),
                    meta: {
                        breadcrumb: [
                            { title: "Principal", url: "/" },
                            { title: "Solicita Pedido", active: true }
                        ],
                        pageTitle: "Solicita Pedido",
                        rule: "editor"
                    }
                },
                {
                    path: "/admin/solicitud/:pedido/VerifyKey/:key",
                    name: "solicitud",
                    component: () =>
                    import ('./divisoft/mandados/mandados.vue'),
                    meta: {
                        pageTitle: "Solicitud",
                        rule: "editor"
                    }
                },
                {
                    ...
                    path: '/Modulo/SOLICITUD_PEDIDO',
                    name: 'SOLICITUD_PEDIDO',
                    component: () =>
                        import ('./divisoft/ob7015/Edit7015.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Principal', url: '/' },
                            { title: 'Registrar Pedido', active: true },
                        ],
                ...
                {
                    path: "/apps/work/:contactId",
                    name: "work",
                    component: () =>
                        import ("./views/apps/work/Work.vue"),
                    beforeEnter(from, to, next) {
                        if (!Vue.prototype.$socket) {
                            require("./plugins/socket-io");
                        }
        ...
        // =============================================================================
        {
            ...
            children: [
...

                {
                    ...
                    name: "page-register",
                    component: () =>
                        import ("@/views/pages/register/RegistroDsoa.vue"),
                    meta: {
                        rule: "editor"
                    }
                },
