    ...
    <vx-card v-if="user_data"> 
      ...
      <div slot="no-body" class="tabs-container px-6 pt-6">
        ...
        <vs-tabs v-model="activeTab" class="tab-action-btn-fill-conatiner">
          ...
          <vs-tab label="Información" icon-pack="feather" icon="icon-info">
            <div class="tab-text">
              <user-edit-tab-information class="mt-4" :data="user_data" />
            </div>
          </vs-tab>
          <vs-tab label="Redes Sociales" icon-pack="feather" icon="icon-share-2">
            <div class="tab-text">
...
export default {
  ...
  created () {
    ...
    this.buscarUser(this.$route.params.userId)
  }
}
</script>