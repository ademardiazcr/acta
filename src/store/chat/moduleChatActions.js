            ...
            let res = await axios({
                ...
                .catch(function(error) {
                    ...
                    if (error.response) {
                        ...
                        console.log("CHAT(1)SE PRODUJO ERROR AA " + error);
                    }
                });
        ...
        try {
            ...
            let res = await axios({
                ...
                .then((response) => {
                    ...
                    console.log("contactos recuperados ", JSON.stringify(response.data));
                ...
                .catch(function(error) {
                    ...
                    if (error.response) {
                        ...
                        // Something happened in setting up the request that triggered an Error
                        console.log("CHAT(2)SE PRODUJO ERROR " + error);
                    }
                });
            ...
            let res = await axios({
                ...
                .catch(function(error) {
                    ...
                    if (error.response) {
                        ...
                        // Something happened in setting up the request that triggered an Error
                        console.log("CHAT(3)SE PRODUJO ERROR " + error);
                    }
                });
