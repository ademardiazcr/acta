...
export default {
    ...
    SEND_CHAT_MESSAGEW(state, payload) {
    ...
    SOCKET_MUTATION_PRIVATE_MESSAGEW(state, payload2) {
    ...
    SOCKET_MUTATION_USER_JOINED_TO_PRIVATE_ROOMW(state, message) {
    ...
    SOCKET_MUTATION_ESTA_CONECTADOW(state, mensaje) {
