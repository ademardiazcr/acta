...
const actions = {
    ...
    async acDsoa({ commit, state }, pet) {
        ...
        //console.log("peticionACDSOA 2020 ", JSON.stringify(datos))
                ...
                let res = await axios({
                    ...
                    .then((response) => {
                        ...
                        try {
                            ...
                            if (data)
                                console.log('LARGO DE RESPUESTA  acDsoa', JSON.stringify(data).length);
                        ...
                        if (pet.indicador == 1 ||pet.indicador == 21 || pet.indicador == 22 || pet.indicador == 23|| pet.indicador == 24|| pet.indicador == 25) {
                            // llena un grid
                            if (
                            ...
                            {
                                data.indicador=pet.indicador;
                                
                                console.log("data",JSON.stringify(data))
                                commit('MUTSETRESPUESTAGRID', data); //carga variable con los datos
                            }
                        ...
                        if (pet.indicador == 21) {
                            //  DATOS CLOUD
                            // console.log("Enviando a MUTSETRESPUESTAE", JSON.stringify(response.data));
                            commit('MUTSETRESPUESTAFORM21', data); //blog
                        }
                        if (pet.indicador == 22) {
                            //  DATOS CLOUD
                            // console.log("Enviando a MUTSETRESPUESTAE", JSON.stringify(response.data));
                            commit('MUTSETRESPUESTAFORM22', data);
                        }
                        if (pet.indicador == 23) {
                            //  DATOS CLOUD
                            // console.log("Enviando a MUTSETRESPUESTAE", JSON.stringify(response.data));
                            commit('MUTSETRESPUESTAFORM23', data);
                        }
                        if (pet.indicador == 24) {
                            //  DATOS CLOUD
                            // console.log("Enviando a MUTSETRESPUESTAE", JSON.stringify(response.data));
                            commit('MUTSETRESPUESTAFORM24', data);
                        }

                        if (pet.indicador ==151)
                            commit('MUTSETRESPUESTA151', response.data);
                    ...
                    .catch(function(error) {
                        ...
                        if (error.response) {
                            ...
                            console.log('(1)acDsoa SE PRODUJO ERROR ' + error);
                        }
                    });
            } catch (error) {
                commit('MUTPROCESANDOFALSE');
