            ...
            let res = await axios({
                ...
                .then((response) => {
                    ...
                    if (tipoLogin == "L") //ñpgom 
                    {
                        ...
                        console.log('MUTSETRESPUESTALOGIN', JSON.stringify(response.data));
                        try {
                            ...
                            if (error == 0) {
                                ...
                                try {
                                    ...
                                    let peticion = {
                                        ...
                                        Roles:strData.Sdt_profile.Roles

                                    }
                                    //alert(strData.Sdt_profile.Roles);
                                    pista = "PASO5 "
                ...
                .catch(function(error) {
                    if (error.response) {
                        ...
                        console.log("ATH(3)acLoginDsoa SE PRODUJO ERROR " + error);
                    }
                });
            ...
            let res = await axios({
                ...
                .catch(function(error) {
                    ...
                    if (error.response) {
                        ...
                        // Something happened in setting up the request that triggered an Error
                        console.log("ATH(2)SE PRODUJO ERROR " + error);
                    }
                });
            ...
            let res = await axios({
                ...
                .catch(function(error) {
                    if (error.response) {
                        ...
                        // Something happened in setting up the request that triggered an Error
                        console.log("ATH(1) SE PRODUJO ERROR " + error + "   " + pista);
                    }
                });
