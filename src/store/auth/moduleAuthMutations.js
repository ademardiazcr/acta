...
export default {
    ...
    MUTSETRESPUESTALOGIN(state, response) {
        ...
        if (error == 0) {
            ...
            console.log('3Creando el parseo del xml');
            ...
            console.log('4Creando el parseo del xml',strData64);

            strData64=strData64.replace("\n"," ");

            strData64=atob(strData64);


            try {
                console.log('JSON DE ',strData64);         
                var strData = JSON.parse(strData64);

                console.log('6Creando el parseo del xml');         
                state.profile[0] = strData.Sdt_profile;
                localStorage.setItem('profile', JSON.stringify(state.profile));
                //pantalla principal
                console.log('7Creando el parseo del xml');         
