...
const mutations = {
    ...
    MUTSETRESPUESTAFORM(state, response) {
       ...
       console.log("MUTSETRESPUESTAFORM", JSON.stringify(response))
        ...
        //console.log("ROWSFORM 2", state.rowsForm);
    },

     //// MUT
     MUTSETRESPUESTAFORM21(state, response) {
        state.dsoaModel = response;
        ...
        state.rowsForm21 = state.datosForm.rows;
        //console.log("ROWSFORM 21", state.rowsForm21);
    },

    MUTFORM21(state, response) {

        state.rowsForm21.push(response);
        console.log("MUTFORM21", state.rowsForm21);
    },

     //// MUT
     MUTSETRESPUESTAFORM22(state, response) {

//        console.log("MUTSETRESPUESTAFORM22", response.datos);

        state.dsoaModel = response;
        try {
            state.datosForm = JSON.parse(response.datos);
            //console.log("oracle22"));
        } catch (e) {
            state.datosForm = response.datos;
            //console.log("php", state.datosForm.rows);
        }

        state.rowsForm22 = state.datosForm.rows;
        //console.log("ROWSFORM 22", state.rowsForm22);
    },

    MUTFORM22(state, response) {

        state.rowsForm22.push(response);
        //console.log("MUTFORM22", state.rowsForm22);
    },

     //// MUT
     MUTSETRESPUESTAFORM23(state, response) {
        ...
        state.rowsForm23 = state.datosForm.rows;
        //console.log("ROWSFORM 1", state.rowsForm);
    },

     //// MUT
     MUTSETRESPUESTAFORM24(state, response) {
        ...
        state.rowsForm24 = state.datosForm.rows;
        //console.log("ROWSFORM 1", state.rowsForm);
    },
    ...
    MUTSETRESPUESTAGRID(state, response) {
        ...
        try {
            ...
            if (response.indicador==21)
              state.datosGrid21 = JSON.parse(response.datos);   

            if (response.indicador==22)
              state.datosGrid22 = JSON.parse(response.datos);   

           if (response.indicador==23)
              state.datosGrid23 = JSON.parse(response.datos);    

           if (response.indicador==24)
              state.datosGrid24 = JSON.parse(response.datos);

            if (response.indicador==25)
              state.datosGrid25 = JSON.parse(response.datos);   
            ...
            if (response.indicador==21)
              state.datosGrid21 = response.datos;

           if (response.indicador==22)
              state.datosGrid22 =response.datos; 

           if (response.indicador==23)
              state.datosGrid23 = response.datos;  

           if (response.indicador==24)
              state.datosGrid24 = response.datos;
    ...
    MUTLIMPIADATAGRIDGRID(state, indicador) { 
        
            if ( indicador==1)
              state.datosGrid = { page: "0", total: "0", registros: "0", rows: [] } 
          
            if ( indicador==21)
              state.datosGrid21 = { page: "0", total: "0", registros: "0", rows: [] }   

            if (indicador==22)
              state.datosGrid22 = { page: "0", total: "0", registros: "0", rows: [] }  

           if ( indicador==23)
              state.datosGrid23 = { page: "0", total: "0", registros: "0", rows: [] }
           if ( indicador==24)
              state.datosGrid24 = { page: "0", total: "0", registros: "0", rows: [] }

            if ( indicador==25)
              state.datosGrid25 = { page: "0", total: "0", registros: "0", rows: [] }   
    ...
    MUTSETRESPUESTA151(state, response) {
         // <Response><PV_RETORNO>25</PV_RETORNO><PN_CODERROR>0</PN_CODERROR><PV_DBMSERROR/></Response>
            let resultado="";
            try {
                resultado = JSON.parse(response.datos);
                //console.log("oracle");
            ...
            if (resultado.indexOf("<PN_CODERROR>0</PN_CODERROR>")>0)
                {
                   let posicion=resultado.indexOf("<PV_RETORNO>");
                   posicion+=12;
                   let posicion2=resultado.indexOf("</PV_RETORNO>");
                   posicion2=posicion2-posicion;
                  state.selectQuery=resultado.substr(posicion,posicion2);
                }
    ...
    MUTSETRECARGAS(state, valor) {
        // llena los campos que contiene la entidad para ser buscada puede ser rowid si es oracle
        state.recargasApp=valor;
    },
