...
const actions = {
    ...
    // ALMACENA EN DIRECTORIO CMS NO DIRECTORIO BITWEB
    async CMSacDsoaPHPCMS({
        commit,
        state
    }, pet) {

        const url = state.urlDsoaPHPCMS;
        ...
        if (pet.Credencial == null) {
            ...
            commit('MUTREGISTRAERROR', jsonError);
             ...
             console.log('acPet ', JSON.stringify(pet));
