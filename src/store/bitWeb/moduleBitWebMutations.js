...
const mutations = {
    ...
    MUTSETRESPUESTASLIDER(state, response) {
        ...
        // aqui es imagen por publicacion
            ...
            if (response.datos.rows) {
                ...
                for (let i = 0; i < items.length; i++) {
                    try {
                        ...
                        //  toma de base 64 la pulbicacion y la pone en publicacion 
                        /*
publicacion
                        {
	"id":8,
	...
	"fecha":"",
	"autor":"",
	"detalle":"Otorga las competencias necesarias para dar soporte al Farmacéutico y cumplir con las operaciones que se desarrollan en una farmacia comunitaria.",
	"contenido":"<p>Otorga las competencias necesarias para dar soporte al Farmacéutico y cumplir con las operaciones que se desarrollan en una farmacia comunitaria.</p><p>&nbsp;</p><p>El Auxiliar en Farmacia, se desarrolla en tres cuatrimestres, de cuatro cursos cada uno. Cada vez que se aprueba un cuatrimestre se hace entrega de un certificado:</p><p>&nbsp;</p><p><strong>Primer Cuatrimestre – Introducción a los Conceptos Básicos para un Auxiliar en Farmacia.</strong></p><p>&nbsp;</p><p>TEF-02 – Generalidades Farmacológicas.</p><p>TEF-04 – Operaciones Farmacéuticas Básicas y la Comunicación en la Relación Terapéutica.</p><p>TEF-06 – Funciones del Asistente en Farmacia.</p><p>TEF-08 – Medicamentos I</p><p>&nbsp;</p><p><strong>Segundo Cuatrimestre – Gestión Administrativa para un Auxiliar en Farmacia.</strong></p><p>&nbsp;</p><p>TEF-10 – Gestión de Medicamentos en Farmacia.</p><p>TEF-12 – Administración de Inventarios en Farmacia.</p><p>TEF-14 – Estructura Diseño y Controles en Farmacia.</p><p>TEF-16 – Medicamentos II.</p><p>&nbsp;</p><p><strong>Tercer Cuatrimestre – Roles Básicos para un Auxiliar en Farmacia.</strong></p><p><strong>&nbsp;</strong></p><p>TEF-18 – Aspectos Básicos de Legislación en Farmacia para Auxiliares.</p><p>TEF-20 – Sistemas de Información en Farmacias.</p><p>TEF-22 – Servicio al Cliente en Farmacias.</p><p>TEF-24 – Medicamentos III.</p><p>&nbsp;</p><p>&nbsp;</p><p>Modalidad 100 Virtual&nbsp;&nbsp;&nbsp; Plataforma de Estudio Digital – CEFI Virtual</p><p>&nbsp;</p><p>Clases: Una vez por semana cada curso (2 horas por clase)</p><p>&nbsp;</p><p>&nbsp;</p><p>Instructor: Lic. Jean Carlo González Guevara.</p><p>Fundador y Director Ejecutivo de Jeca Pharma, empresa que investiga y formula productos farmacéuticos.</p><p>&nbsp;</p><p>Ganador del Premio Rodolfo Jiménez Borbón, concurso Actitud Emprendedora de Competencia de Negocios Yo Emprendedor 2016.</p>",
	"link":"/vdesarrollo",
	"REFERENCIA_IMAGEN":0,
	"REFERENCIA_PDF":0,
	"REFERENCIA_VIDEO":0,
