...
<vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
   ...
   <table class="table">   
     ...
     <filtrosDivisoft v-show="activaFiltro" :header="locallastheader"  :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros"  :ObjectID=7015   @closeSidebar="activaFiltro = false" 
...
export default {
        ...
        onDoubleClicked(event) {
            //LIMPIA TABLEKEY
              ...
              let rowsSelection = this.gridOptions.api.getSelectedRows();  
                    eventBus.$emit('datosprompt',rowsSelection[0],7015  )//this.datosPrompt[0].idprompt);
                    this.$parent.activaP7015 = false;
 ...
 filas.push({ NOMBRE: "IND_ESTADO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
  ...
  this.dinamicKey.push({ nombre: "NUM_PEDIDO", valor: "0" }); 
