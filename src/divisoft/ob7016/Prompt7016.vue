...
<vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
   ...
   <table class="table">   
     ...
     <filtrosDivisoft v-show="activaFiltro" :header="locallastheader"  :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros"  :ObjectID=7016   @closeSidebar="activaFiltro = false" 
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos7016.columnDefs;
        var defaultdatos = datos7016.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            //LIMPIA TABLEKEY
              ...
              let rowsSelection = this.gridOptions.api.getSelectedRows();  
                    eventBus.$emit('datosprompt',rowsSelection[0],7016  )//this.datosPrompt[0].idprompt);
                    this.$parent.activaP7016 = false;
      ...
      // addFilas Gen_CAMPOS_GRID(1)
            addFilas: function() {
            var filas = [];
 filas.push({ NOMBRE: "SECUENCIA_BLOG", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("mutsetDatosDefault", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "SECUENCIA_BLOG", valor: "0" }); 
